    ...
    <main className="home">
      <section className="hero" aria-labelledby="hero-title">
        <div className="hero__scene" aria-hidden="true">
          ...
          <div className="scene__thread">
            ...
            <div className="scene__status">
              Camera locked until both users consent
            </div>
          </div>
        </div>
        <div className="hero__content">
          ...
          <p className="lede">
            Meet a stranger for one-to-one text chat, keep real identity
            private, and decide whether to stay anonymous or sign in for
            stronger controls.
          </p>
      ...
      <section className="intro" aria-labelledby="intro-title">
        <div>
          ...
          <h2 id="intro-title">
            A stranger chat flow built for low friction and clear boundaries.
          </h2>
        </div>
        <p>
          Fahhhchat starts with anonymous text matching and keeps the MVP
          focused: no voice, no video, no public online counts, no long-lived
          chat history, and no promise that view-once media can stop
          screenshots.
        </p>
      </section>
      ...
      <section className="split" aria-labelledby="guest-title">
        <div className="split__content">
          ...
          <p>
            Guests can begin after confirming adult status and accepting the
            current legal versions. The app assigns a generated name and avatar,
            then places everyone in the shared matching pool so wait times stay
            low.
          </p>
        </div>
      ...
      <section className="split split--reverse" aria-labelledby="login-title">
        <div className="split__content">
          ...
          <h2 id="login-title">
            Google login adds continuity without exposing Google identity.
          </h2>
          <p>
            Logged-in users still appear through generated names and avatars.
            Signing in supports persistent preferences, gender filter
            eligibility, appeals, account deletion, and camera media only when
            both matched people are logged in.
          </p>
        </div>
      ...
      <section className="safety-band" aria-labelledby="safety-title">
        <div className="section-heading">
          ...
          <h2 id="safety-title">
            Built to explain the rules before the first match.
          </h2>
        </div>
      ...
      <section className="final-cta" aria-labelledby="cta-title">
        ...
        <div className="actions">
          <ButtonLink href="http://localhost:3001">
            Open the chat app
          </ButtonLink>
      ...
      <nav className="public-links" aria-label="Public legal and support pages">
